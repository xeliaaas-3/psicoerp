      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          <div className="nav-section">
            ...
            {/* Dashboard — solo psicóloga/admin */}
            {!esSecretaria && (
              <NavLink to="/" end className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>
                <IconGrid /> Dashboard
              </NavLink>
          ...
          {/* Sección clínica — solo psicóloga/admin */}
          {!esSecretaria && (
            <div className="nav-section">
              <div className="nav-section-label">Clínico</div>
              <NavLink to="/fichas" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>
          ...
          {/* Gestión de usuarios — solo admin/psicóloga */}
          {!esSecretaria && (
            <div className="nav-section">
              <div className="nav-section-label">Sistema</div>
              <NavLink to="/usuarios" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                border: 'none', background: 'rgba(45,106,79,0.12)',
                color: 'var(--sage)', cursor: 'pointer',
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                flexShrink: 0, transition: 'background .15s',
              }}
              onMouseOver={e => e.currentTarget.style.background = 'rgba(45,106,79,0.22)'}
              onMouseOut={e => e.currentTarget.style.background = 'rgba(45,106,79,0.12)'}
            >
